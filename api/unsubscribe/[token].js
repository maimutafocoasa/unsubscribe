...
// If you set a URL here (e.g. https://douglashops.com/unsubscribe-page),
...
<head>
  <meta charset="utf-8">
  <title>Unsubscribe • Douglas Hops</title>
  ...
  <div class="wrap">
    <div class="card">
      <div style="display:flex;align-items:center;margin-bottom:6px">
        <span class="ok"></span>
        <div class="brand">Douglas Hops</div>
      </div>
      <h1>You're unsubscribed</h1>
      <p>You will no longer receive marketing emails from <strong>Douglas Hops</strong> at <strong>${esc(maskEmail(email))}</strong>.</p>
      <div class="actions">
